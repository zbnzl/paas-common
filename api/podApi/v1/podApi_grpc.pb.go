...
type PodApiClient interface {
	FindPodById(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
	AddPod(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
	DeletePodById(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
	UpdatePod(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
	// 默认接口
...
func (c *podApiClient) FindPodById(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *podApiClient) AddPod(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *podApiClient) DeletePodById(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *podApiClient) UpdatePod(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedPodApiServer) FindPodById(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindPodById not implemented")
}
func (UnimplementedPodApiServer) AddPod(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddPod not implemented")
}
func (UnimplementedPodApiServer) DeletePodById(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeletePodById not implemented")
}
func (UnimplementedPodApiServer) UpdatePod(context.Context, *Request) (*Response, error) {
...
func _PodApi_FindPodById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PodApiServer).FindPodById(ctx, req.(*Request))
	}
...
func _PodApi_AddPod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PodApiServer).AddPod(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PodApi_DeletePodById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PodApiServer).DeletePodById(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PodApi_UpdatePod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PodApiServer).UpdatePod(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PodApi_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/podApi/v1/podApi.proto",
}
